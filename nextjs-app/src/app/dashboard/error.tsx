      ...
      <div className="bg-card-bg border border-border-color rounded-2xl shadow-sm p-8 max-w-md w-full text-center space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-text-secondary mt-1">
            {error.message || "Gagal memuat data dashboard. Sesuatu yang tidak terduga terjadi."}
          </p>
        </div>
        ...
        <div className="pt-2">
          <button
            type="button"
            onClick={() => reset()}
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-primary-green hover:bg-dark-green text-white text-sm font-semibold transition shadow-sm hover:shadow active:scale-[0.98]"
          >
